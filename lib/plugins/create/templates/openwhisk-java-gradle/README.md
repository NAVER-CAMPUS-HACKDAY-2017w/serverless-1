# Serverless OpenWhisk Java/Gradle Template

Hello! 😎

This is a template Java/Gradle service for the OpenWhisk platform. Before you can deploy your service, please follow the instructions below…
...
Use the `serverless` command to deploy your service. The sample `/src/main/java/com/serverless/Handler.java` file will be compiled and jar package will be deployed.
